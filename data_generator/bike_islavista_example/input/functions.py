...
def generate_report_location(context, max_miles=5, iv_bounds=None, attempts=10):
	import math
	import random

	if iv_bounds is None:
...
def choose_return_station(context, max_miles=5, iv_bounds=None):
	import math
	import random
